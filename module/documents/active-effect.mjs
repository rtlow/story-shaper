 ...
 */
export default class ActiveEffectShaper extends ActiveEffect {
   ...
   * @param {ActorShaper} actor            The Actor to whom this effect should be applied.
   ...
   * @param {ActorShaper|ItemShaper} owner  The owning document which manages this effect
   ...
   * @param {ActiveEffectShaper[]} effects  The array of Active Effect instances to prepare sheet data for
